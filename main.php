                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 pb-5 pb-lg-0 mb-lg-0">
                            ...
                            <h6>Introducing Bookstory</h6>

                            <h1 class="text-white mb-4">Bookstory landing page for every person with a heart for reading</h1>

                            <a href="#section_2" class="btn custom-btn smoothscroll me-3">Discover More</a>

                            <a href="#section_3" class="link link--kale smoothscroll">Meet the Authors</a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="book-section-info">
                                ...
                                <h2 class="mb-4">About The Books</h2>

                                <p>Credit goes to <a rel="nofollow" href="https://.com" target="_blank">Leart</a> for images used in this ebook landing page template. You may browse FreePik to download more free images for your website.</p>

                                <p>Bookstory has one of the best books you can ever imagine. Our team make sure to add the latest books for a better expirience with our users</p>
                            </div>
                        </div>
